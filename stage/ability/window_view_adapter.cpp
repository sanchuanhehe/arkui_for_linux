...
// Linux/Wayland native port: this translation unit was already pure C++ on macOS
// (it stores opaque window-view handles as void*); only the .mm -> .cpp rename is
// needed. The void* entries point at the Wayland surface objects owned by the
// view glue layer (StageViewController / WindowView).
